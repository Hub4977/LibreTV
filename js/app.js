// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy","dyttzy","bfzy","ruyi","ffzy","heimuer","zy360","wolong","jisu","dbzy","mdzy","zuid","yinghua","wujin","lzi"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["tyyszy", "bfzy", "dyttzy", "ruyi", "ffzy", "heimuer", "zy360", "wolong", "jisu", "dbzy", "mdzy", "zuid", "yinghua", "wujin", "lzi"];
